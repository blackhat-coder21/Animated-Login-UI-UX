...
import com.example.chatapp.databinding.ActivityRegisterFacebookBinding
import com.google.firebase.auth.FirebaseAuth

class RegisterFacebook : AppCompatActivity() {
    lateinit var binding: ActivityRegisterFacebookBinding
